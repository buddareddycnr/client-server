...
public class InvalidMobileNumberFormatException extends RuntimeException{
     ...
     * @since 1.4
     */
    public InvalidMobileNumberFormatException(Throwable cause) {
        super(cause);
    }
     ...
     * @since 1.7
     */
    public InvalidMobileNumberFormatException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
